...
// The picture each faction borrows from its own Exalted achievement, keyed by the faction id the
// reputation was recorded under — the same shape as the bosses, and the backend hops behind it.
