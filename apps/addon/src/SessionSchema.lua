...
---The shape of every list-valued field a session carries, in one place. Both the tally
...
---@param keys string[] The keys to carry across, from ns.sessionEventSpecs.
